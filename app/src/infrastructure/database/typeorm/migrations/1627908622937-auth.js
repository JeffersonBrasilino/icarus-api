...
module.exports = class auth1627908622937 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas"."status" IS 'situacao do registro. 1 - ativo, 0 - inativo'`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas"."created_at" IS 'data de criacao do registro'`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas"."updated_at" IS 'data de ALTERACAO do registro'`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas"."deleted_at" IS 'data de EXCLUSAO do registro(soft-delete)'`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas_acoes"."status" IS 'situacao do registro. 1 - ativo, 0 - inativo'`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas_acoes"."created_at" IS 'data de criacao do registro'`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas_acoes"."updated_at" IS 'data de ALTERACAO do registro'`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas_acoes"."deleted_at" IS 'data de EXCLUSAO do registro(soft-delete)'`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas_acoes"."deleted_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas_acoes"."updated_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas_acoes"."created_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas_acoes"."status" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas"."deleted_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas"."updated_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas"."created_at" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "api_rotas"."status" IS NULL`);
